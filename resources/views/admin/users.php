...
<link rel="stylesheet" href="/public/assets/css/admin/users.css">
...
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/admin/users"><i class="fas fa-users"></i> Manage Users</a></li>
                        ...
                        <?php if (!empty($data['users'])): ?>
                            <?php foreach ($data['users'] as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/assign_badge/<?php echo $user['user_id']; ?>" method="POST" style="display:inline-flex; gap: 5px;">
                                        ...
                                        <form action="/admin/toggle_ban/<?php echo $user['user_id']; ?>" method="POST" style="display:inline-flex; gap: 5px; margin-left: 10px;">
