<?php
/**
 * Admin View: Backup & Restore
 *
 * Provides two operations for administrators:
 *   1. Download a full SQL export of core system data.
 *   2. Upload a .sql file to restore the database (overwrites existing data).
 */
...
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <!-- "Backup & Restore" is the currently active page -->
    ...
    <main class="admin-main">
        ...
        <section class="admin-content">
            ...
            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:16px; margin-bottom:14px;">
                ...
                <!-- Links to the backup_download route which triggers the SQL file generation and download -->
            ...
            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:16px;">
                ...
                <p>Upload a <code>.sql</code> file to restore data. This can overwrite existing data.</p>
                ...
                <form method="POST" action="<?= BASE_URL ?>/admin/restore_backup" enctype="multipart/form-data">
                    <!-- Only accept .sql or plain-text files -->
                    <input type="file" name="backup_sql" accept=".sql,text/plain" required>
                    <!-- Confirmation dialog warns the admin before overwriting data -->
