...
<link rel="stylesheet" href="/public/assets/css/admin/announcements.css">
...
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/admin/announcements"><i class="fas fa-bullhorn"></i> Announcements</a></li>
                        ...
                        <?php if (!empty($data['announcements'])): ?>
                            <?php foreach ($data['announcements'] as $ann): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/toggle_announcement/<?php echo $ann['announcement_id']; ?>" method="POST">
                                    ...
                                    <td>
                                        <form action="/admin/delete_announcement/<?php echo $ann['announcement_id']; ?>" method="POST" onsubmit="return confirm('Delete this announcement?');" style="display:inline;">
