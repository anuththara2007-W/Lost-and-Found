...
<div class="form-container" style="margin-top: 5px; margin-bottom: 40px; max-width: 550px;border:1px solid grey ;">
    ...
    <form action="<?= BASE_URL ?>/auth/register" method="POST">
        <div class="input-group">
            ...
            <input type="text" id="full_name" name="full_name" class="input-field" placeholder="John Doe" required value="<?= old('full_name') ?>">
        </div>

        <div style="display:flex; gap:16px;">
            <div class="input-group" style="flex:1;">
                <label class="input-label" for="username">Username</label>
                <input type="text" id="username" name="username" class="input-field" placeholder="johndoe88" required value="<?= old('username') ?>">
            </div>

            <div class="input-group" style="flex:1;">
                <label class="input-label" for="phone">Phone (Optional)</label>
                <input type="text" id="phone" name="phone" class="input-field" placeholder="+65 9123 4567" value="<?= old('phone') ?>">
            </div>
        </div>

        <div class="input-group">
            <label class="input-label" for="email">Email Address</label>
            <input type="email" id="email" name="email" class="input-field" placeholder="john@example.com" required value="<?= old('email') ?>">
        </div>
        ...
        <button type="submit" class="btn btn-found w-full mt-20" style="padding: 12px; font-size: 15px;">Register</button>
    </form>
